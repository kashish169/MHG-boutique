...
class AllowNotification extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => InkWell(
      onTap: (){
        controller.notificationAllowed.value=!controller.notificationAllowed.value;
      },
      child: ColoredBox(
          ...
          child: Row(
            children: [
              ...
              Column(
                ...
                children: [
                  Text('Allow Notifications',style: Theme.of(context).textTheme.displaySmall,),
                  const SizedBox(height: 5,),
                  Text('Stay up to date on latest offers and more',style: Theme.of(context).textTheme.displaySmall?.copyWith(
                      fontSize: 10,
