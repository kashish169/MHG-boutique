...
.method public run(Landroidx/media2/session/MediaController$ControllerCallback;)V
    ...
    iget-object p0, p0, Landroidx/media2/session/MediaControllerImplLegacy$ControllerCompatCallback$5;->val$state:Landroid/support/v4/media/session/PlaybackStateCompat;

    invoke-virtual {p0}, Landroid/support/v4/media/session/PlaybackStateCompat;->getPlaybackSpeed()F

    move-result p0

    invoke-virtual {p1, v0, p0}, Landroidx/media2/session/MediaController$ControllerCallback;->onPlaybackSpeedChanged(Landroidx/media2/session/MediaController;F)V
