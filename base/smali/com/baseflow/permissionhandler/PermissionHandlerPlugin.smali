...
.method private deregisterListeners()V
    ...
    iget-object p0, p0, Lcom/baseflow/permissionhandler/PermissionHandlerPlugin;->permissionManager:Lcom/baseflow/permissionhandler/PermissionManager;
...
.method private registerListeners()V
    ...
    invoke-interface {v0, p0}, Lio/flutter/plugin/common/PluginRegistry$Registrar;->addRequestPermissionsResultListener(Lio/flutter/plugin/common/PluginRegistry$RequestPermissionsResultListener;)Lio/flutter/plugin/common/PluginRegistry$Registrar;
...
.method private startListening(Landroid/content/Context;Lio/flutter/plugin/common/BinaryMessenger;)V
    ...
    .line 115
    iget-object p0, p0, Lcom/baseflow/permissionhandler/PermissionHandlerPlugin;->methodChannel:Lio/flutter/plugin/common/MethodChannel;

    invoke-virtual {p0, p2}, Lio/flutter/plugin/common/MethodChannel;->setMethodCallHandler(Lio/flutter/plugin/common/MethodChannel$MethodCallHandler;)V
...
.method private startListeningToActivity(Landroid/app/Activity;)V
    ...
    .line 127
    iget-object p0, p0, Lcom/baseflow/permissionhandler/PermissionHandlerPlugin;->methodCallHandler:Lcom/baseflow/permissionhandler/MethodCallHandlerImpl;

    if-eqz p0, :cond_0

    .line 128
    invoke-virtual {p0, p1}, Lcom/baseflow/permissionhandler/MethodCallHandlerImpl;->setActivity(Landroid/app/Activity;)V
...
.method private stopListeningToActivity()V
    ...
    .line 134
    invoke-virtual {p0, v0}, Lcom/baseflow/permissionhandler/MethodCallHandlerImpl;->setActivity(Landroid/app/Activity;)V
