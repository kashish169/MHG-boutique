...
.method private final maybeReleaseConnection(Ljava/io/IOException;Z)Ljava/io/IOException;
    ...
    :cond_d
    :try_start_1
    const-string p0, "cannot release connection while it is in use"
...
.method private final timeoutExit(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    .line 102
    :cond_0
    iget-object p0, p0, Lokhttp3/internal/connection/Transmitter;->timeout:Lokhttp3/internal/connection/Transmitter$timeout$1;

    invoke-virtual {p0}, Lokhttp3/internal/connection/Transmitter$timeout$1;->exit()Z
...
.method public final newExchange$okhttp(Lokhttp3/Interceptor$Chain;Z)Lokhttp3/internal/connection/Exchange;
    ...
    iget-object v7, p0, Lokhttp3/internal/connection/Transmitter;->exchangeFinder:Lokhttp3/internal/connection/ExchangeFinder;
    ...
    invoke-direct/range {v3 .. v8}, Lokhttp3/internal/connection/Exchange;-><init>(Lokhttp3/internal/connection/Transmitter;Lokhttp3/Call;Lokhttp3/EventListener;Lokhttp3/internal/connection/ExchangeFinder;Lokhttp3/internal/http/ExchangeCodec;)V
    ...
    :cond_3
    :try_start_2
    const-string p0, "cannot make a new request because the previous response is still open: please call response.close()"
...
.method public final timeoutEnter()V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/connection/Transmitter$timeout$1;->enter()V
