...
.method isLastTaskInTransaction()Z
    ...
    .line 43
    iget-object p0, p0, Lcom/tekartik/sqflite/DatabaseWorker;->lastTask:Lcom/tekartik/sqflite/DatabaseTask;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lcom/tekartik/sqflite/DatabaseTask;->isInTransaction()Z
...
.method lastTaskDatabaseId()Ljava/lang/Integer;
    ...
    invoke-virtual {p0}, Lcom/tekartik/sqflite/DatabaseTask;->getDatabaseId()Ljava/lang/Integer;
...
.method work(Lcom/tekartik/sqflite/DatabaseTask;)V
    ...
    .line 57
    iget-object p0, p0, Lcom/tekartik/sqflite/DatabaseWorker;->onIdle:Ljava/lang/Runnable;
